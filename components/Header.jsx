...
const Header = () => {
  ...
  return (
    <motion.header
      className="fixed top-0 max-w-full overflow-hidden left-0 right-0 z-50 transition-all duration-500 border-b bg-slate-900/85 backdrop-blur-md border-slate-700 shadow-lg shadow-slate-900/20"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      transition={{ duration: 0.8, ease: "easeOut" }}
    >
      <nav className="flex items-center justify-between w-full px-4 md:px-6 py-4">
