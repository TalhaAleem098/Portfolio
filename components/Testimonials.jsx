  ...
  const testimonials = [
    {
      ...
      company: 'CenturyPK',
      testimonial: 'You provided us a good e-commerce store for our business startup. The website was prepared fully according to our needs. I really liked it!',
      rating: 5,
    },
    {
      id: 2,
      name: 'Ali Malik',
      role: 'Fiver Company & Training institue',
      company: 'EVS Lahore',
      testimonial: "Aleem you're included in my good books. You really have good programming and logic building skills.",
      rating: 5,
    },
    {
      id: 3,
      ...
      role: 'Actor',
      company: 'Sydney',
      testimonial: 'Thanks for providing me a great image gallery website. I really love the design structure of the website.',
      rating: 5,
